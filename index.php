...
// 总记录数
$sql_total = "SELECT COUNT(*) as total FROM app_cards";
$result_total = mysqli_query($conn, $sql_total);
$row_total = mysqli_fetch_assoc($result_total);
$total_pages = ceil($row_total['total'] / $items_per_page);

// 查询当前页数据
$sql = "SELECT * FROM app_cards LIMIT $start, $items_per_page";
$result = mysqli_query($conn, $sql);

require_once 'api/WAF_IP.php';
...
<body>
    ...
    <div class="navbar">
        ...
        <a href="https://qm.qq.com/q/SILXyAB0c0" class="nav-link">加入Q群</a>
    </div>
    ...
    <?php while ($row = mysqli_fetch_assoc($result)): ?>
        <div class="app-card">
            <div class="app-card-details">
                ...
                <div>
                    ...
                    <?php if (!empty($row['app_source_url'])): ?>
                        <p><span class="bold-label">相关链接：</span><a href="<?php echo $row['app_source_url']; ?>"><?php echo "立即前往"; ?></a></p>
                    <?php endif; ?>
            ...
            <a href="<?php echo $row['app_download_url']; ?>" class="download-btn">立即下载</a>
        </div>
    <?php endwhile;?>
